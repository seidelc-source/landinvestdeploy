...
| `result_rows` | 157 |
| `packet_rows` | 157 |
| `reviewer_accept_rows` | 29 |
| `pending_review_rows` | 0 |
| `accepted_override_rows` | 29 |
| `accepted_provider_years` | 29 |
| `accepted_candidate_counties` | 27 |
| `held_or_rejected_rows` | 128 |
| `skipped_existing_override_rows` | 0 |
| `skipped_duplicate_agrees_rows` | 0 |
| `rejected_conflict_rows` | 0 |
| `manual_override_rows_before` | 437 |
| `manual_override_rows_after` | 466 |

## Acceptance Status Counts

- `accepted`: `29`
- `held_or_rejected`: `128`
