...
| `result_rows` | 83 |
| `packet_rows` | 116 |
| `reviewer_accept_rows` | 32 |
| `pending_review_rows` | 0 |
| `accepted_override_rows` | 32 |
| `accepted_provider_years` | 32 |
| `accepted_candidate_counties` | 32 |
| `held_or_rejected_rows` | 51 |
| `skipped_existing_override_rows` | 0 |
| `skipped_duplicate_agrees_rows` | 0 |
| `rejected_conflict_rows` | 0 |
| `manual_override_rows_before` | 478 |
| `manual_override_rows_after` | 510 |
